Public Class GDate
  ...
  Public Function ElapsedDay(gdate As GDate) As Integer

    Return ElapsedDay(gdate.Year, gdate.Month, gdate.Day) - ElapsedDay(_Year, _month, _day)
  ...
  Public Function WeekDay() As Integer

    Return (ElapsedDay(_year, _month, _day) - 1) Mod 7
